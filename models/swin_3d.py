...
class WindowAttention3D(nn.Module):
    def __init__(self, dim, window_size, num_heads, qkv_bias = False, qk_scale = None, attn_drop = 0, proj_drop = 0):
        ...
        self.register_buffer("relatice_position_index", relative_position_index)
    ...
    def forward(self, x, mask = None):
        ...
        q = q*self.scale
        attn = q @ k.tramspose(-2,-1)
        relative_position_bias = self.relative_position_bias_table[self.relative_postion_index[:N,:N].reshape(-1)].reshape(N,N,-1)
